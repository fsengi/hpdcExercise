...
#SBATCH --output=one_node_nonBlocking.out     # file to collect standard output
#SBATCH --error=one_node_nonBlocking.err      # file to collect standard errors
